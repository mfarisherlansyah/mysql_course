...
# SELECT first_name, title, grade FROM students, papers WHERE students.id = student_id ORDER BY grade DESC;

# SELECT first_name, title, grade FROM students JOIN papers ON students.id = papers.student_id ORDER BY grade DESC;

# SELECT first_name, title, grade FROM students
# LEFT JOIN papers
#     ON students.id = papers.student_id ORDER BY students.id;
...
# LEFT JOIN papers
#     ON students.id = papers.student_id GROUP BY students.id ORDER BY AVG(grade) DESC;
